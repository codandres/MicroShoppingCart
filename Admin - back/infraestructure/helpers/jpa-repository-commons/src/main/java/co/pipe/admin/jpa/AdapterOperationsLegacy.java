...
public abstract class AdapterOperationsLegacy<E, D, I, R extends CrudRepository<D, I> & QueryByExampleExecutor<D>> {
    ...
    public AdapterOperationsLegacy(R repository, ObjectMapper mapper, Function<D, E> toEntityFn) {
